...
// The artwork was replaced in place, so keep each public image URL versioned.
// This prevents a browser or image optimizer from serving an older opaque copy.
const assetVersion = "20260902-model-map";
const imageAsset = (path: string) => `${path}?v=${assetVersion}`;
...
const productSeeds: ProductSeed[] = [
  ...
  { asset: "HALO", sideAsset: "Halo", lookAsset: "halo-new.png.png", code: "BLR-03", name: "Halo", priceUSD: 192, description: "A narrow silver orbit with a violet cast.", frameColor: "Polished titanium", lensColor: "Lilac gradient", dimensions: "145mm / 34mm / 130mm", material: "Titanium / UV400 lens", fit: "Narrow / medium", inventory: 5 },
  ...
  { asset: "CLEARCUT", lookAsset: "halo.png", code: "BLR-06", name: "Clearcut", priceUSD: 172, description: "A barely-there rectangle held by a precise metal line.", frameColor: "Clear acetate / titanium", lensColor: "Soft graphite", dimensions: "143mm / 36mm / 126mm", material: "Titanium / UV400 lens", fit: "Narrow", inventory: 6 },
  ...
  { asset: "THORNLINE", lookAsset: "clearcut.png", code: "BLR-09", name: "Thornline", priceUSD: 194, description: "A precise titanium cat-eye with engineered points.", frameColor: "Polished titanium", lensColor: "Clear smoke", dimensions: "144mm / 37mm / 127mm", material: "Titanium / UV400 lens", fit: "Narrow / medium", inventory: 4 },
  { asset: "VAPOR", lookAsset: "thornline.png", code: "BLR-10", name: "Vapor", priceUSD: 178, description: "A clear technical wrap with a warm translucent tint.", frameColor: "Crystal smoke acetate", lensColor: "Warm brown", dimensions: "153mm / 39mm / 132mm", material: "Titanium / UV400 lens", fit: "Medium / wide", inventory: 8 },
...
export const products: Product[] = productSeeds.map(({ asset, sideAsset = asset, lookAsset, ...product }, index) => ({
  ...
  primaryImage: imageAsset(`/products/${asset}-hero.png`),
  galleryImages: [
    imageAsset(`/products/${asset}-hero.png`),
    imageAsset(`/products/${sideAsset}-side.png`),
    imageAsset(`/products/${asset}-rear.png`),
  ],
  lookImage: imageAsset(`/looks/${lookAsset}`),
}));
